# 🔧 Troubleshooting Guide — Terraform Drift Auditor
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-terraform-drift/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/terraform-drift/)
